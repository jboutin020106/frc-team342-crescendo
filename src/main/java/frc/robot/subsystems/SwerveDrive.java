...
public class SwerveDrive extends SubsystemBase {
  ...
  public void periodic() { 
    if(LimelightHelpers.getTV(LimelightConstants.AMP_SIDE_LIMELIGHT_NAME)){
        swerveOdometry.update(new Rotation2d(getHeading() - LimelightHelpers.getTX(LimelightConstants.AMP_SIDE_LIMELIGHT_NAME)), getModulePositions());
    }

    if(LimelightHelpers.getTV(LimelightConstants.SHOOTER_SIDE_LIMELIGHT_NAME)){
        swerveOdometry.update(new Rotation2d(getHeading() - LimelightHelpers.getTX(LimelightConstants.SHOOTER_SIDE_LIMELIGHT_NAME)), getModulePositions());
    }
